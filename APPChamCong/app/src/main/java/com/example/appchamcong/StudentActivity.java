...
public class StudentActivity extends AppCompatActivity {
    ...
    private void loadStudentData() {
        ...
        while (cursor.moveToNext()){
            ...
            Log.i("Student","LoadData: "+cid);
            Log.i("Student","Student sid: "+sid );
            Log.i("Student","Student roll: "+roll );
    ...
    private void setToolbar() {
        ...
        subtitle=toolbar.findViewById(R.id.title_sub);
    ...
    private void saveStatus() {
        for (StudentItem studentItem : studentItems) {
            ...
            long sid=studentItem.getSid();
            long value = dbHelper.addStatus(sid, cid, calendar.getDate(), status);
            if (value == -1)
                dbHelper.updateStatust(sid, calendar.getDate(), status);
        }
    }
    ...
    private void loadStatusData() {
        for (StudentItem studentItem : studentItems) {
            ...
            if (status == null) {studentItem.setStatus("  ");}
            else {studentItem.setStatus(status);}
        }
...
//    }
    ...
    private void deleteStudent(int position) {
        dbHelper.deletStudent(studentItems.get(position).getSid());
